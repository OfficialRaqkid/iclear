<x-master-layout :breadcrumbs="['Registrar', 'Dashboard']" sidebar="dashboard.registrar.partials.sidebar"
    navbar="dashboard.registrar.partials.navbar" footer="dashboard.student.partials.footer">
